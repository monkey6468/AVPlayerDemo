...
@interface CombineOperation : NSObject
//网络资源下载取消后的回调block
...
//处理网络资源缓存类
@interface CacheHelpler : NSObject
//单例
...
@interface DownloadOperation : NSOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
