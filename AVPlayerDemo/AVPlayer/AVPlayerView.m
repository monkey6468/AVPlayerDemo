...
#warning <#message#>
                wself.sourceURL = wself.sourceURL;//[wself.sourceURL.absoluteString urlScheme:@"streaming"];
            }else {
...
-(void)retry {
    [self cancelLoading];
#warning <#message#>
    _sourceURL = _sourceURL.absoluteString;//[_sourceURL.absoluteString urlScheme:_sourceScheme];
...
#warning <#message#>
        NSURL *URL = nil;//[[loadingRequest.request URL].absoluteString urlScheme:_sourceScheme];
